    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          בעת ההרשמה (לרבות דרך Google/Apple), אנו אוספים מידע בסיסי כגון שם, כתובת דוא"ל ותמונת פרופיל. בנוסף, האפליקציה עשויה לאסוף מידע טכני וסטטיסטי כגון כתובת IP, סוג מכשיר, דפדפן, זמני שימוש ונתוני אינטראקציה (Cookies/Analytics) לצורך שיפור השירות, אבטחתו וניתוח ביצועיו.
        </Text>
        ...
        <Text style={styles.paragraph}>
          אנו משתמשים בסטנדרטים מקובלים בתעשייה לאבטחת נתונים, אך איננו יכולים להבטיח חסינות מוחלטת מפני פריצות. השימוש באפליקציה מותר אך ורק למשתמשים מעל גיל 13.
        </Text>
